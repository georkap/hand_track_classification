...
from utils.train_utils import CyclicLR, train, test, LRRangeTest
...
batch_size = 128
max_epochs = 100
lr_range = [0.001, 0.002, 0.005, 0.008, 0.01, 0.02, 0.04, 0.07, 0.1, 0.5, 1., 2., 3.]

log_file = os.path.join(base_output_dir, model_name, model_name+"_{}.txt".format("range"))
...
optimizer = torch.optim.SGD(params_to_update,
                            lr=start_lr, momentum=start_mom, weight_decay=start_decay)
